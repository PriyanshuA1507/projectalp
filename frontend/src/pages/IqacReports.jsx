...
//         // Ensure academicYear exists and is in "YYYY-YY" format before splitting
//         if (!academicYear || !academicYear.includes('-')) return true;

//         const startYear = academicYear.split('-')[0]; // e.g., "2023"
//         const endYear = `20${academicYear.split('-')[1]}`; // e.g., "2024"

//         // 1. Direct match check
//         if (item.academic_year && item.academic_year === academicYear) return true;

//         // 2. Extracted year check
...
//         // Keep item if it matches EITHER the start or end year of the session
