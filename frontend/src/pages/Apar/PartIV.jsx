        ...
        <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-sm space-y-8">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* 1(a) */}
                    <div className="flex flex-col gap-2">
                        <label htmlFor="curr-dev" className="text-sm font-semibold text-gray-700">
                            1) a) Curriculum Development
                        </label>
                        <textarea 
                            id="curr-dev" 
                            ...
                            disabled={readOnly} 
                            value={corporate.curriculum_development || ''} 
                            onChange={(e) => updateField('corporate', 'curriculum_development', e.target.value)} 
                            ...
                            placeholder="Details of curriculum development..."
                        />
                    </div>

                    {/* 1(b) */}
                    <div className="flex flex-col gap-2">
                        <label htmlFor="course-dev" className="text-sm font-semibold text-gray-700">
                            1) b) Courses Development
                        </label>
                        <textarea 
                            id="course-dev" 
                            ...
                            disabled={readOnly} 
                            value={corporate.course_development_details || ''} 
                            onChange={(e) => updateField('corporate', 'course_development_details', e.target.value)} 
                            className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2.5 disabled:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors" 
                            placeholder="Details of courses development/revised..."
                        />
                    </div>
            ...
            {/* 2) Laboratory Development */}
            <div>
                <label htmlFor="lab-dev" className="block text-sm font-semibold text-gray-700 mb-2">
                ...
                <textarea 
                    ...
                    rows={4} 
                    disabled={readOnly} 
                    value={corporate.lab_development || ''} 
                    onChange={(e) => updateField('corporate', 'lab_development', e.target.value)} 
                    className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-4 disabled:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors" 
                    placeholder="Describe laboratory development and experimental setup..."
                />
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* 3(a) */}
                    <div className="flex flex-col gap-2">
                        <label htmlFor="cultural" className="text-sm font-semibold text-gray-700">
                            3) a) Cultural / Extracurricular Activities
                        </label>
                        <textarea 
                            id="cultural" 
                            ...
                            disabled={readOnly} 
                            value={corporate.cultural_activities || ''} 
                            onChange={(e) => updateField('corporate', 'cultural_activities', e.target.value)} 
                            className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2.5 disabled:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors" 
                            placeholder="Details of cultural or extracurricular activities..."
                        />
                    </div>

                    {/* 3(b) */}
                    <div className="flex flex-col gap-2">
                        <label htmlFor="sports" className="text-sm font-semibold text-gray-700">
                            3) b) Sports / Community / Extension Services / N.S.S
                        </label>
                        <textarea 
                            id="sports" 
                            ...
                            disabled={readOnly} 
                            value={corporate.sports_community || ''} 
                            onChange={(e) => updateField('corporate', 'sports_community', e.target.value)} 
                            className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2.5 disabled:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors" 
                            placeholder="Details of sports or community extension services..."
                        />
                    </div>
                    ...
                    {/* 3(d) */}
                    <div className="flex flex-col gap-2">
                        <label htmlFor="other" className="text-sm font-semibold text-gray-700">
                            3) d) Any Other
                        </label>
                        <textarea 
                            id="other" 
                            ...
                            disabled={readOnly} 
                            value={corporate.any_other || ''} 
                            onChange={(e) => updateField('corporate', 'any_other', e.target.value)} 
                            className="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500 px-4 py-2.5 disabled:bg-gray-200 disabled:text-gray-500 disabled:cursor-not-allowed transition-colors" 
                            placeholder="Any other institutional contributions..."
                        />
                    </div>
                </div>
            </div>
